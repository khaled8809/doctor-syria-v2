...
from doctor.models import Doctor, DoctorSchedule, Prescription, DoctorReview, Specialization
...
class TestDoctor:
    ...
    def test_specialization_doctors(self, test_specialization, test_doctor):
        ...
        test_doctor.is_available = False
        test_doctor.save()
        assert test_doctor in test_specialization.get_active_doctors()  # Still active even if not available
