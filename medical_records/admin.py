...
from .models import MedicalRecord, MedicalVisit, Prescription, LabTest, Radiology, Vaccination, Medication, Inventory, InventoryTransaction, MedicalReport, FollowUp, Treatment, Progress, Invoice, InvoiceItem, Payment, Insurance, InsuranceClaim

@admin.register(MedicalRecord)
class MedicalRecordAdmin(admin.ModelAdmin):
    list_display = ['patient', 'blood_type', 'created_at', 'updated_at']
    list_filter = ['blood_type', 'created_at']
    search_fields = ['patient__first_name', 'patient__last_name', 'allergies', 'chronic_diseases']
    ...
    fieldsets = (
        ...
        (_('Medical Information'), {
            'fields': ('allergies', 'chronic_diseases', 'medications', 'family_history')
        }),
        (_('Emergency Contact'), {
...
class PrescriptionAdmin(admin.ModelAdmin):
    list_display = ['visit', 'medication_name', 'dosage', 'frequency', 'is_active', 'created_at']
    list_filter = ['is_active', 'created_at']
    search_fields = ['medication_name', 'visit__patient__first_name', 'visit__patient__last_name']
    readonly_fields = ['created_at']
    fieldsets = (
...
class LabTestAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_('Test Details'), {
            'fields': ('test_date', 'results_date', 'results')
        }),
        (_('Additional Information'), {
            'fields': ('notes',)
        }),
...
class RadiologyAdmin(admin.ModelAdmin):
    list_display = ['visit', 'radiology_type', 'body_part', 'performed_at', 'created_at']
    list_filter = ['radiology_type', 'performed_at']
    search_fields = ['body_part', 'visit__patient__first_name', 'visit__patient__last_name']
    readonly_fields = ['created_at']
...
class VaccinationAdmin(admin.ModelAdmin):
    list_display = ['patient', 'vaccine_name', 'dose_number', 'date_given', 'next_due_date']
    ...
    fieldsets = (
        (_('Vaccination Information'), {
            'fields': ('patient', 'vaccine_name', 'dose_number', 'date_given', 'next_due_date')
        }),
...
class MedicationAdmin(admin.ModelAdmin):
    list_display = ['name', 'generic_name', 'manufacturer', 'dosage_form', 'price', 'requires_prescription']
    ...
    fieldsets = (
        ...
        (_('Details'), {
            'fields': ('description', 'dosage_form', 'strength', 'price')
        }),
        (_('Requirements'), {
...
class InventoryAdmin(admin.ModelAdmin):
    list_display = ['medication', 'batch_number', 'expiry_date', 'quantity', 'is_low_stock', 'is_expired']
...
class InventoryTransactionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_('Details'), {
            'fields': ('reference', 'notes', 'performed_by')
        }),
        (_('System Information'), {
            'fields': ('created_at',),
            'classes': ('collapse',)
...
class MedicalReportAdmin(admin.ModelAdmin):
    list_display = ['patient', 'doctor', 'report_type', 'title', 'is_confidential', 'created_at']
    ...
    fieldsets = (
        ...
        (_('Additional Information'), {
            'fields': ('is_confidential', 'attachments')
        }),
        (_('System Information'), {
            'fields': ('created_at', 'updated_at'),
            'classes': ('collapse',)
...
class FollowUpAdmin(admin.ModelAdmin):
    list_display = ['patient', 'doctor', 'title', 'priority', 'status', 'scheduled_date', 'is_overdue']
...
class TreatmentAdmin(admin.ModelAdmin):
    list_display = ['follow_up', 'treatment_type', 'name', 'frequency', 'start_date', 'is_completed', 'is_active']
    list_filter = ['treatment_type', 'frequency', 'is_completed', 'start_date']
    search_fields = ['name', 'description', 'follow_up__patient__first_name', 'follow_up__patient__last_name']
    readonly_fields = ['created_at', 'updated_at']
...
class ProgressAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_('Details'), {
            'fields': ('observations', 'complications', 'next_steps')
        }),
        (_('Recording'), {
...
class InvoiceAdmin(admin.ModelAdmin):
    list_display = ['invoice_number', 'patient', 'status', 'issue_date', 'due_date', 'total', 'is_overdue']
...
class InsuranceAdmin(admin.ModelAdmin):
    list_display = ['patient', 'provider', 'policy_number', 'coverage_type', 'status', 'start_date', 'end_date', 'is_active']
...
class InsuranceClaimAdmin(admin.ModelAdmin):
    list_display = ['claim_number', 'insurance', 'invoice', 'status', 'submission_date', 'amount_claimed', 'amount_approved']
    list_filter = ['status', 'submission_date', 'processed_date', 'payment_date']
    search_fields = ['claim_number', 'insurance__policy_number', 'invoice__invoice_number']
    readonly_fields = ['created_at', 'updated_at']
    date_hierarchy = 'submission_date'
    fieldsets = (
        (_('Claim Information'), {
            'fields': ('claim_number', 'insurance', 'invoice')
        }),
        (_('Claim Details'), {
            'fields': ('amount_claimed', 'amount_approved', 'status')
        }),
        (_('Dates'), {
            'fields': ('submission_date', 'processed_date', 'payment_date')
        }),
