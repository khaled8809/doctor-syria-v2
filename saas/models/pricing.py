...
class PlanSubscription(models.Model):
    ...
    tenant = models.ForeignKey(Tenant, on_delete=models.CASCADE, related_name='plan_subscriptions')
...
class SubscriptionAddon(models.Model):
    ...
    subscription = models.ForeignKey(PlanSubscription, on_delete=models.CASCADE, related_name='addons')
...
class LoyaltyProgram(models.Model):
    """نموذج برنامج الولاء"""
    tenant = models.ForeignKey(Tenant, on_delete=models.CASCADE, related_name='loyalty_programs')
    name = models.CharField(max_length=100)
...
class LoyaltyPoints(models.Model):
    """نموذج نقاط الولاء"""
    program = models.ForeignKey(LoyaltyProgram, on_delete=models.CASCADE, related_name='points')
