    ...
    def post(self, request):
        ...
        try:
            ...
            try:
                ...
                raise InvalidBarcodeDataError('بيانات الباركود غير صالحة: تنسيق JSON غير صحيح')
            ...
            if (user.username != data['username'] or 
                ...
                raise InvalidBarcodeDataError('بيانات الباركود لا تتطابق مع بيانات المستخدم')
    ...
    def post(self, request):
        ...
        try:
            ...
            if not user.is_profile_complete():
                raise ValidationError('يجب إكمال الملف الشخصي قبل توليد البطاقة التعريفية')
