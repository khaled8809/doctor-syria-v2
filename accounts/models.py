...
class User(AbstractUser):
    ...
    two_factor_enabled = models.BooleanField(
        default=False,
        verbose_name=_('تفعيل المصادقة الثنائية')
    )
    ...
    two_factor_secret = models.CharField(
        ...
        null=True,
        blank=True,
        verbose_name=_('سر المصادقة الثنائية')
    )

    email_verified = models.BooleanField(
        default=False,
        verbose_name=_('تم التحقق من البريد')
    )
    ...
    account_locked_until = models.DateTimeField(
        null=True,
        blank=True,
        verbose_name=_('الحساب مقفل حتى')
    )

    last_password_change = models.DateTimeField(
        default=timezone.now,
        verbose_name=_('آخر تغيير لكلمة المرور')
    )
    ...
    device_info = models.JSONField(
        default=dict,
        verbose_name=_('معلومات الأجهزة')
    )
    ...
    id_card = models.CharField(
        ...
        blank=True,
        null=True,
        verbose_name=_('البطاقة التعريفية')
    )
    ...
    def is_support_staff(self):
        ...
        return self.is_pharmacist() or self.is_lab_technician() or self.is_receptionist()
