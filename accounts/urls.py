...
urlpatterns = [
    ...
    path('profile/medical-info/', views.update_medical_info, name='update_medical_info'),
    ...
    path('email/verify/confirm/', views.verify_email_confirm, name='verify_email_confirm'),
    ...
    path('api/id-card/regenerate/', RegenerateIDCardView.as_view(), name='regenerate_id_card'),
]
