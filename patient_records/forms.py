...
class MedicalRecordForm(forms.ModelForm):
    class Meta:
        model = MedicalRecord
        fields = ['patient', 'blood_type', 'height', 'weight', 'allergies', 'chronic_conditions']
        widgets = {
...
class MedicalVisitForm(forms.ModelForm):
    class Meta:
        model = MedicalVisit
        fields = ['patient', 'doctor', 'visit_type', 'visit_date', 'symptoms', 'diagnosis', 'treatment', 'notes', 'follow_up_date']
        widgets = {
