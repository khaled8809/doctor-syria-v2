...
urlpatterns = [
    ...
    path('nursing-rounds/<int:pk>/', views.nursing_round_detail, name='nursing_round_detail'),
    ...
    path('doctor-rounds/<int:pk>/', views.doctor_round_detail, name='doctor_round_detail'),
    ...
    # API Endpoints
    path('api/bed-availability/', views.bed_availability_api, name='bed_availability_api'),
    path('api/department-stats/', views.department_stats_api, name='department_stats_api'),
    path('api/inventory-alerts/', views.inventory_alerts_api, name='inventory_alerts_api'),
]
