...
class PreventiveCheckup(models.Model):
    patient = models.ForeignKey(User, on_delete=models.CASCADE, related_name='preventive_checkups')
...
class HealthTip(models.Model):
    ...
    target_conditions = models.JSONField(default=dict)  # Store conditions this tip applies to
    created_at = models.DateTimeField(auto_now_add=True)
