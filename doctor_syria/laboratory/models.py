...
from accounts.models import Laboratory, Patient, Doctor
...
class TestRequest(models.Model):
    ...
    doctor = models.ForeignKey(Doctor, on_delete=models.CASCADE, related_name='test_requests', null=True, blank=True)
    laboratory = models.ForeignKey(Laboratory, on_delete=models.CASCADE, related_name='test_requests')
...
class ReferenceRange(models.Model):
    test = models.ForeignKey(LabTest, on_delete=models.CASCADE, related_name='reference_ranges')
    parameter = models.CharField(max_length=100)
    min_value = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    max_value = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    unit = models.CharField(max_length=50)
    gender = models.CharField(max_length=20, null=True, blank=True)  # For gender-specific ranges
    min_age = models.PositiveIntegerField(null=True, blank=True)  # For age-specific ranges
