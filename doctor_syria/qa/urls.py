...
urlpatterns = [
    ...
    path('category/<slug:category_slug>/', views.QuestionListView.as_view(), name='category_questions'),
    path('question/<slug:slug>/', views.QuestionDetailView.as_view(), name='question_detail'),
    path('ask/', views.QuestionCreateView.as_view(), name='ask_question'),
    path('question/<slug:slug>/edit/', views.QuestionUpdateView.as_view(), name='edit_question'),
    ...
    # المفضلة
    path('question/<int:question_id>/bookmark/', views.toggle_bookmark, name='toggle_bookmark'),
]
