...
class MedicineAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (_('معلومات أساسية'), {
            'fields': (
                'name', 'scientific_name', 'category',
                'form', 'manufacturer', 'description'
            )
        }),
        (_('معلومات فنية'), {
            'fields': (
                'dosage', 'storage_condition',
...
class InventoryAdmin(admin.ModelAdmin):
    ...
    list_filter = [
        'medicine__category', 'supplier',
        'purchase_date', 'expiry_date'
    ]
    search_fields = [
        'medicine__name', 'batch_number',
        'supplier'
    ]
    readonly_fields = [
        'created_at', 'updated_at',
...
class OrderAdmin(admin.ModelAdmin):
    ...
    search_fields = [
        'patient__name', 'delivery_address'
    ]
    readonly_fields = [
    ...
    fieldsets = (
        ...
        (_('معلومات الدفع'), {
            'fields': (
                ...
                'insurance_coverage', 'final_amount'
            )
        }),
        (_('ملاحظات'), {
            'fields': (
