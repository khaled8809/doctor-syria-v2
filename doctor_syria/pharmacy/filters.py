...
class MedicineFilter(django_filters.FilterSet):
    ...
    class Meta:
        model = Medicine
        fields = [
            'name', 'scientific_name', 'category', 'form',
            'manufacturer', 'requires_prescription', 'is_available'
        ]
...
class InventoryFilter(django_filters.FilterSet):
    ...
    فلتر المخزون
    """
    medicine = django_filters.CharFilter(field_name='medicine__name', lookup_expr='icontains')
    ...
    expiry_date_min = django_filters.DateFilter(field_name='expiry_date', lookup_expr='gte')
    expiry_date_max = django_filters.DateFilter(field_name='expiry_date', lookup_expr='lte')
    supplier = django_filters.CharFilter(lookup_expr='icontains')
    purchase_date_min = django_filters.DateFilter(field_name='purchase_date', lookup_expr='gte')
    purchase_date_max = django_filters.DateFilter(field_name='purchase_date', lookup_expr='lte')

    class Meta:
        model = Inventory
        fields = [
            'medicine', 'batch_number', 'supplier',
...
class OrderFilter(django_filters.FilterSet):
    ...
    فلتر الطلبات
    """
    patient = django_filters.CharFilter(field_name='patient__name', lookup_expr='icontains')
