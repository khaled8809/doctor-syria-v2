...
def get_medical_locations(request, area_id):
    ...
    for clinic in clinics:
        data.append({
            ...
            'latitude': float(clinic.latitude) if hasattr(clinic, 'latitude') else None,
            'longitude': float(clinic.longitude) if hasattr(clinic, 'longitude') else None
        })
    ...
    for hospital in hospitals:
        data.append({
            ...
            'latitude': float(hospital.latitude) if hasattr(hospital, 'latitude') else None,
            'longitude': float(hospital.longitude) if hasattr(hospital, 'longitude') else None
        })
