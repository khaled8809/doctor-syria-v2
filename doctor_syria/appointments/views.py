...
class PrescriptionListCreateView(generics.ListCreateAPIView):
    ...
    search_fields = ['appointment__doctor__user__first_name', 'appointment__patient__user__first_name']
...
class MedicalRecordListCreateView(generics.ListCreateAPIView):
    ...
    search_fields = ['doctor__user__first_name', 'patient__user__first_name', 'diagnosis']
