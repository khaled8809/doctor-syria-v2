...
class NotificationPreference(models.Model):
    ...
    quiet_hours_start = models.TimeField(
        null=True,
        blank=True,
        verbose_name=_('بداية ساعات الهدوء')
    )
    quiet_hours_end = models.TimeField(
        null=True,
        blank=True,
        verbose_name=_('نهاية ساعات الهدوء')
    )
