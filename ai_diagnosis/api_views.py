...
from .models import (
    DiagnosisSession, DiagnosisResult, Symptom,
    Disease, AIModel, PredictionModel
)
from .services import DiagnosisService, PredictionService
from .serializers import (
    DiagnosisSessionSerializer, SymptomSerializer,
    DiseaseSerializer, DiagnosisResultSerializer
)
...
class DiagnosisViewSet(viewsets.ModelViewSet):
    ...
    def add_symptom(self, request, pk=None):
        ...
        try:
            ...
            session.symptoms.add(
                symptom,
                through_defaults={'severity': severity}
            )
