...
from .models import (
    ...
    AIModel, PredictionModel, SessionSymptom
)
...
class DiseaseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Disease
        fields = [
            'id', 'name', 'description', 'symptoms', 'icd_code',
            'risk_level', 'common_treatments'
        ]
...
class DiagnosisSessionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'patient', 'doctor', 'ai_model', 'symptoms',
...
class DiagnosisResultSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'reasoning', 'recommendations', 'created_at'
        ]
...
class PredictionModelSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'parameters', 'accuracy', 'last_training_date',
