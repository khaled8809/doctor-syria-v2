...
class InvoiceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Invoice
        fields = [
            'id', 'invoice_number', 'patient', 'patient_name', 'doctor', 'doctor_name',
            'appointment', 'status', 'status_display', 'payment_method', 'payment_method_display',
            'subtotal', 'tax', 'discount', 'total', 'notes', 'created_at', 'updated_at',
            'due_date', 'paid_at', 'items'
        ]
...
class PaymentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'payment_method_display', 'transaction_id', 'status', 'status_display',
...
class InsuranceClaimSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'invoice', 'invoice_number', 'insurance_provider',
            'insurance_provider_name', 'claim_number', 'status', 'status_display',
            'amount_claimed', 'amount_approved', 'submitted_at', 'processed_at',
            'notes'
        ]
...
class InvoicePDFSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Invoice
        fields = [
            'invoice_number', 'patient_name', 'doctor_name', 'hospital_info',
            'created_at', 'due_date', 'items', 'subtotal', 'tax', 'discount',
            'total', 'notes', 'status', 'payment_method'
        ]
